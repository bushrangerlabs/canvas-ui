# Canvas UI - Widget API Implementation Focus
...
## 🎯 CURRENT FOCUS: Widget API Redesign
  ...
  static getMetadata() {
    return {
      ...
      fields: {
        ...
        // === CUSTOM CATEGORY ===
        text: {  // Object syntax for complex fields
          name: 'text',
          type: 'text',
          default: 'Click Me',
          label: 'Button Text',
        ...
        borderStyle: 'borderStyle:select:solid:Border Style:solid,dashed,dotted,double',
